...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='系统配置表格';
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1676238846687182848, 1636182933754609665, 4, 'com.zrkizzy.web.controller.system.LinkController.listLinks()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"currentPage\":1,\"dataRange\":[],\"pageSize\":10}]', 'Result(code=200, message=请求成功, data={list=[{website=https://banq.ink/, introduce=Semisunny, updateTime=1687331851000, createTime=1687330423000, name=半晴Miko, logo=https://www.static.banq.ink/sunnyBlog/avatar/fcc72d35fc928185c3e70773a29a310f.jpg, id=1671411053646315520}], total=1})', 1, 46, '2023-07-04 22:37:39', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1676498669781647360, 1636182933754609665, 4, 'com.zrkizzy.web.controller.system.LinkController.listLinks()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"currentPage\":1,\"dataRange\":[],\"pageSize\":10}]', 'Result(code=200, message=请求成功, data={list=[{website=https://banq.ink/, introduce=Semisunny, updateTime=1687331851000, createTime=1687330423000, name=半晴Miko, logo=https://www.static.banq.ink/sunnyBlog/avatar/fcc72d35fc928185c3e70773a29a310f.jpg, id=1671411053646315520}], total=1})', 1, 89, '2023-07-05 15:50:05', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1679134410772840448, 1636182933754609665, 4, 'com.zrkizzy.web.controller.system.LinkController.listLinks()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"currentPage\":1,\"dataRange\":[],\"pageSize\":10}]', 'Result(code=200, message=请求成功, data={list=[{website=https://banq.ink/, introduce=Semisunny, updateTime=1687331851000, createTime=1687330423000, name=半晴Miko, logo=https://www.static.banq.ink/sunnyBlog/avatar/fcc72d35fc928185c3e70773a29a310f.jpg, id=1671411053646315520}], total=1})', 1, 165, '2023-07-12 22:23:35', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1679152859997798400, 1636182933754609665, 3, 'com.zrkizzy.web.controller.monitor.OnlineController.offlineUser()', 'DELETE', 1653794265890816000, '127.0.0.1', '本地登录', '[\"1679148698765885440\"]', 'Result(code=200, message=请求成功, data=null)', 1, 3, '2023-07-12 23:36:54', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1679153124125704192, 1636182933754609665, 3, 'com.zrkizzy.web.controller.monitor.OnlineController.offlineUser()', 'DELETE', 1653794265890816000, '127.0.0.1', '本地登录', '[\"1679130827243388928\"]', 'Result(code=200, message=请求成功, data=null)', 1, 0, '2023-07-12 23:37:57', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1679157982115397632, 1636182933754609665, 3, 'com.zrkizzy.web.controller.monitor.OnlineController.offlineUser()', 'DELETE', 1653794265890816000, '127.0.0.1', '本地登录', '[\"1679148814230880256\"]', 'Result(code=200, message=请求成功, data=null)', 1, 0, '2023-07-12 23:57:15', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1679836654258356224, 1636182933754609665, 4, 'com.zrkizzy.web.controller.system.LinkController.listLinks()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"currentPage\":1,\"dataRange\":[],\"pageSize\":10}]', 'Result(code=200, message=请求成功, data={list=[{website=https://banq.ink/, introduce=Semisunny, updateTime=1687331851000, createTime=1687330423000, name=半晴Miko, logo=https://www.static.banq.ink/sunnyBlog/avatar/fcc72d35fc928185c3e70773a29a310f.jpg, id=1671411053646315520}], total=1})', 1, 43, '2023-07-14 20:54:03', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1680183441259233280, 1636182933754609665, 3, 'com.zrkizzy.web.controller.monitor.CacheController.clearCacheKeys()', 'DELETE', 1653794265890816000, '127.0.0.1', '本地登录', '[\"captcha:\"]', 'Result(code=200, message=请求成功, data=null)', 1, 0, '2023-07-15 19:52:03', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1680231076905091072, 1636182933754609665, 3, 'com.zrkizzy.web.controller.monitor.CacheController.deleteCacheKey()', 'DELETE', 1653794265890816000, '127.0.0.1', '本地登录', '[\"captcha:1680230908587671552\"]', 'Result(code=200, message=请求成功, data=null)', 1, 2, '2023-07-15 23:01:21', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1680235728878960640, 1636182933754609665, 3, 'com.zrkizzy.web.controller.monitor.CacheController.deleteCacheKey()', 'DELETE', 1653794265890816000, '127.0.0.1', '本地登录', '[\"captcha:1680235666417385472\"]', 'Result(code=200, message=请求成功, data=null)', 1, 2, '2023-07-15 23:19:50', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1680236540690694144, 1636182933754609665, 3, 'com.zrkizzy.web.controller.monitor.CacheController.deleteCacheKey()', 'DELETE', 1653794265890816000, '127.0.0.1', '本地登录', '[\"captcha:1680235694112374784\"]', 'Result(code=200, message=请求成功, data=null)', 1, 2, '2023-07-15 23:23:03', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683012981316648960, 1636182933754609665, 3, 'com.zrkizzy.web.controller.monitor.CacheController.deleteCacheKey()', 'DELETE', 1653794265890816000, '127.0.0.1', '本地登录', '[\"config:basic\"]', 'Result(code=200, message=请求成功, data=null)', 1, 0, '2023-07-23 15:15:38', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683014881030176768, 1636182933754609665, 3, 'com.zrkizzy.web.controller.monitor.CacheController.deleteCacheKey()', 'DELETE', 1653794265890816000, '127.0.0.1', '本地登录', '[\"config:basic\"]', 'Result(code=200, message=请求成功, data=null)', 1, 0, '2023-07-23 15:23:11', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683099059398639616, 1636182933754609665, 2, 'com.zrkizzy.web.controller.system.ConfigController.saveConfig()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192353.jpg\",\"createTime\":\"2023-07-22T22:38:28\",\"id\":1682761996493127680,\"updateTime\":\"2023-07-23T20:56:25\"}]', 'Result(code=200, message=请求成功, data=1)', 1, 51, '2023-07-23 20:57:41', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683099087357870080, 1636182933754609665, 2, 'com.zrkizzy.web.controller.system.ConfigController.saveConfig()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"createTime\":\"2023-07-22T22:38:28\",\"id\":1682761996493127680,\"updateTime\":\"2023-07-23T20:56:25\"}]', 'Result(code=200, message=请求成功, data=1)', 1, 44, '2023-07-23 20:57:48', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683117411781312512, 1636182933754609665, 2, 'com.zrkizzy.web.controller.system.ConfigController.saveConfig()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"createTime\":\"2023-07-22T22:38:28\",\"id\":1682761996493127680,\"notice\":\"<p><strong style=\\\"color: rgb(96, 98, 102);\\\">尊敬的用户：</strong></p><p>欢迎来到我的个人博客! 我是Dream_飞翔，非常感谢您的来访。这里是我分享自己生活、学习和工作中的一些体验与见解的地方。您可以随意浏览我的文章以及后台的所有页面，也可以在评论区分享您的想法和反馈。如果您有任何问题或建议，请与我联系，祝您生活愉快！</p><p><strong style=\\\"color: rgb(96, 98, 102);\\\">其他：</strong></p>\",\"updateTime\":\"2023-07-23T20:57:48\"}]', 'Result(code=200, message=请求成功, data=1)', 1, 116, '2023-07-23 22:10:36', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683118951694860288, 1636182933754609665, 2, 'com.zrkizzy.web.controller.system.ConfigController.saveConfig()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"createTime\":\"2023-07-22T22:38:28\",\"id\":1682761996493127680,\"notice\":\"<p><strong style=\\\"color: rgb(96, 98, 102);\\\">尊敬的用户：</strong></p><p>欢迎来到我的个人博客! 我是Dream_飞翔，非常感谢您的来访。这里是我分享自己生活、学习和工作中的一些体验与见解的地方。您可以随意浏览我的文章以及后台的所有页面，也可以在评论区分享您的想法和反馈。如果您有任何问题或建议，请与我联系，祝您生活愉快！</p><p><strong style=\\\"color: rgb(96, 98, 102);\\\">其他：</strong></p>\",\"updateTime\":\"2023-07-23T22:10:36\"}]', 'Result(code=200, message=请求成功, data=1)', 1, 17, '2023-07-23 22:16:44', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683362033854054400, 1636182933754609665, 2, 'com.zrkizzy.web.controller.system.ConfigController.saveConfig()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"createTime\":\"2023-07-22T22:38:28\",\"id\":1682761996493127680,\"notice\":\"<p><strong style=\\\"color: rgb(96, 98, 102);\\\">尊敬的用户：</strong></p><p>欢迎来到我的个人博客! 我是Dream_飞翔，非常感谢您的来访。这里是我分享自己生活、学习和工作中的一些体验与见解的地方。您可以随意浏览我的文章以及后台的所有页面，也可以在评论区分享您的想法和反馈。如果您有任何问题或建议，请与我联系，祝您生活愉快！</p><p><strong style=\\\"color: rgb(96, 98, 102);\\\">其他：</strong></p><p>目前项目的技术栈为SpringBoot2，后续我会向SpringBoot3进行迁移</p>\",\"updateTime\":\"2023-07-23T22:16:44\"}]', 'Result(code=200, message=请求成功, data=1)', 1, 603, '2023-07-24 14:22:39', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683379061117681664, 1636182933754609665, 2, 'com.zrkizzy.web.controller.system.ConfigController.saveConfig()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"createTime\":\"2023-07-22T22:38:28\",\"id\":1682761996493127680,\"notice\":\"<p><strong style=\\\"color: rgb(96, 98, 102);\\\">尊敬的用户：</strong></p><p>欢迎来到我的个人博客! 我是Dream_飞翔，非常感谢您的来访。这里是我分享自己生活、学习和工作中的一些体验与见解的地方。您可以随意浏览我的文章以及后台的所有页面，也可以在评论区分享您的想法和反馈。如果您有任何问题或建议，请与我联系，祝您生活愉快！</p><p><strong style=\\\"color: rgb(96, 98, 102);\\\">其他：</strong></p><p>目前项目的技术栈为SpringBoot2，后续我会向SpringBoot3进行迁移</p>\",\"updateTime\":\"2023-07-24T14:22:38\",\"upload\":\"OSS策略\"}]', 'Result(code=200, message=请求成功, data=1)', 1, 590, '2023-07-24 15:30:19', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683380858574077952, 1636182933754609665, 2, 'com.zrkizzy.web.controller.system.ConfigController.saveConfig()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"createTime\":\"2023-07-22T22:38:28\",\"id\":1682761996493127680,\"notice\":\"<p><strong style=\\\"color: rgb(96, 98, 102);\\\">尊敬的用户：</strong></p><p>欢迎来到我的个人博客! 我是Dream_飞翔，非常感谢您的来访。这里是我分享自己生活、学习和工作中的一些体验与见解的地方。您可以随意浏览我的文章以及后台的所有页面，也可以在评论区分享您的想法和反馈。如果您有任何问题或建议，请与我联系，祝您生活愉快！</p><p><strong style=\\\"color: rgb(96, 98, 102);\\\">其他：</strong></p><p>目前项目的技术栈为SpringBoot2，后续我会向SpringBoot3进行迁移</p>\",\"updateTime\":\"2023-07-24T15:30:17\",\"upload\":\"本地策略\"}]', 'Result(code=200, message=请求成功, data=1)', 1, 842, '2023-07-24 15:37:27', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683380871144407040, 1636182933754609665, 2, 'com.zrkizzy.web.controller.system.ConfigController.saveConfig()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"createTime\":\"2023-07-22T22:38:28\",\"id\":1682761996493127680,\"notice\":\"<p><strong style=\\\"color: rgb(96, 98, 102);\\\">尊敬的用户：</strong></p><p>欢迎来到我的个人博客! 我是Dream_飞翔，非常感谢您的来访。这里是我分享自己生活、学习和工作中的一些体验与见解的地方。您可以随意浏览我的文章以及后台的所有页面，也可以在评论区分享您的想法和反馈。如果您有任何问题或建议，请与我联系，祝您生活愉快！</p><p><strong style=\\\"color: rgb(96, 98, 102);\\\">其他：</strong></p><p>目前项目的技术栈为SpringBoot2，后续我会向SpringBoot3进行迁移</p>\",\"updateTime\":\"2023-07-24T15:30:17\",\"upload\":\"OSS策略\"}]', 'Result(code=200, message=请求成功, data=1)', 1, 300, '2023-07-24 15:37:30', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683381561250021376, 1636182933754609665, 2, 'com.zrkizzy.web.controller.system.ConfigController.saveConfig()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"createTime\":\"2023-07-22T22:38:28\",\"id\":1682761996493127680,\"notice\":\"<p><strong style=\\\"color: rgb(96, 98, 102);\\\">尊敬的用户：</strong></p><p>欢迎来到我的个人博客! 我是Dream_飞翔，非常感谢您的来访。这里是我分享自己生活、学习和工作中的一些体验与见解的地方。您可以随意浏览我的文章以及后台的所有页面，也可以在评论区分享您的想法和反馈。如果您有任何问题或建议，请与我联系，祝您生活愉快！</p><p><strong style=\\\"color: rgb(96, 98, 102);\\\">其他：</strong></p><p>目前项目的技术栈为SpringBoot2，后续我会向SpringBoot3进行迁移</p>\",\"updateTime\":\"2023-07-24T15:37:29\",\"upload\":\"OSS策略\"}]', 'Result(code=200, message=请求成功, data=1)', 1, 466, '2023-07-24 15:40:15', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683381930478796800, 1636182933754609665, 2, 'com.zrkizzy.web.controller.system.ConfigController.saveConfig()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"createTime\":\"2023-07-22T22:38:28\",\"id\":1682761996493127680,\"notice\":\"<p><strong style=\\\"color: rgb(96, 98, 102);\\\">尊敬的用户：</strong></p><p>欢迎来到我的个人博客! 我是Dream_飞翔，非常感谢您的来访。这里是我分享自己生活、学习和工作中的一些体验与见解的地方。您可以随意浏览我的文章以及后台的所有页面，也可以在评论区分享您的想法和反馈。如果您有任何问题或建议，请与我联系，祝您生活愉快！</p><p><strong style=\\\"color: rgb(96, 98, 102);\\\">其他：</strong></p><p>目前项目的技术栈为SpringBoot2，后续我会向SpringBoot3进行迁移</p>\",\"updateTime\":\"2023-07-24T15:40:14\",\"upload\":\"oss\"}]', 'Result(code=200, message=请求成功, data=1)', 1, 515, '2023-07-24 15:41:43', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683461431996973056, 1636182933754609665, 3, 'com.zrkizzy.web.controller.monitor.OnlineController.offlineUser()', 'DELETE', 1653794265890816000, '127.0.0.1', '本地登录', '[\"1683460984645091328\"]', 'Result(code=200, message=请求成功, data=null)', 1, 15, '2023-07-24 20:57:37', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683482282171564032, 1636182933754609665, 2, 'com.zrkizzy.web.controller.system.ConfigController.saveConfig()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"createTime\":\"2023-07-22T22:38:28\",\"id\":1682761996493127680,\"notice\":\"<p><strong style=\\\"color: rgb(96, 98, 102);\\\">尊敬的用户：</strong></p><p>欢迎来到我的个人博客! 我是Dream_飞翔，非常感谢您的来访。这里是我分享自己生活、学习和工作中的一些体验与见解的地方。您可以随意浏览我的文章以及后台的所有页面，也可以在评论区分享您的想法和反馈。如果您有任何问题或建议，请与我联系，祝您生活愉快！</p><p><strong style=\\\"color: rgb(96, 98, 102);\\\"><span class=\\\"ql-cursor\\\">﻿﻿</span></strong><img src=\\\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/article/20230724214014.jpeg\\\" width=\\\"263\\\" style=\\\"display: block; margin: auto; cursor: nwse-resize;\\\"></p><p><strong style=\\\"color: rgb(96, 98, 102);\\\">其他：</strong></p><p>目前项目的技术栈为SpringBoot2，后续我会向SpringBoot3进行迁移</p><p><br></p>\",\"updateTime\":\"2023-07-24T22:19:59\",\"upload\":\"oss\"}]', 'Result(code=200, message=请求成功, data=1)', 1, 91, '2023-07-24 22:20:28', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683838895151644672, 1636182933754609665, 2, 'com.zrkizzy.web.controller.core.UserController.updateLoginUser()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"id\":1653794265890816000,\"nickname\":\"测试账号\",\"phone\":\"\",\"remark\":\"自古英雄出炼狱，破马长枪定乾坤！\",\"username\":\"1072876976@qq.com\"}]', 'BusinessException(httpStatusEnum=USERNAME_REPEAT)', 0, 32, '2023-07-25 21:57:31', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683838917595365376, 1636182933754609665, 2, 'com.zrkizzy.web.controller.core.UserController.updateLoginUser()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"id\":1653794265890816000,\"nickname\":\"测试账号\",\"phone\":\"\",\"remark\":\"自古英雄出炼狱，破马长枪定乾坤！\",\"username\":\"26755255371@qq.com\"}]', 'Result(code=200, message=请求成功, data=1)', 1, 34, '2023-07-25 21:57:37', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683839046201114624, 1636182933754609665, 2, 'com.zrkizzy.web.controller.core.UserController.updateLoginUser()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"id\":1653794265890816000,\"nickname\":\"测试账号1\",\"phone\":\"\",\"remark\":\"自古英雄出炼狱，破马长枪定乾坤！\",\"username\":\"2675525537@qq.com\"}]', 'Result(code=200, message=请求成功, data=1)', 1, 38, '2023-07-25 21:58:07', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683842257704189952, 1636182933754609665, 1, 'com.zrkizzy.web.controller.core.UserController.insert()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"nickname\":\"12\",\"status\":true,\"username\":\"123@qq.com\"}]', 'java.lang.NullPointerException: Cannot invoke \"com.zrkizzy.data.domain.Role.getId()\" because the return value of \"com.zrkizzy.data.mapper.RoleMapper.getRoleByMark(String)\" is null', 0, 182, '2023-07-25 22:10:53', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683843226953318400, 1636182933754609665, 1, 'com.zrkizzy.web.controller.core.UserController.insert()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"nickname\":\"123\",\"status\":true,\"username\":\"1@qq.com\"}]', 'Result(code=200, message=请求成功, data=true)', 1, 207, '2023-07-25 22:14:44', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683843898905985024, 1636182933754609665, 2, 'com.zrkizzy.web.controller.core.UserController.updateLoginUser()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"id\":1653794265890816000,\"nickname\":\"测试账号1\",\"phone\":\"\",\"remark\":\"自古英雄出炼狱，破马长枪定乾坤！\",\"username\":\"1072876976@qq.com\"}]', '用户名重复，当前用户名已存在', 0, 39, '2023-07-25 22:17:24', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683848577727594496, 1636182933754609665, 2, 'com.zrkizzy.web.controller.core.UserController.updateUser()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"createTime\":\"2023-07-25T22:14:44\",\"id\":1683843225900548096,\"nickname\":\"1234\",\"updateTime\":\"2023-07-25T22:14:44\",\"username\":\"1@qq.com\"}]', 'Result(code=200, message=请求成功, data=true)', 1, 95, '2023-07-25 22:36:00', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683848617430876160, 1636182933754609665, 2, 'com.zrkizzy.web.controller.core.UserController.updateUser()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"createTime\":\"2023-07-25T22:14:44\",\"id\":1683843225900548096,\"nickname\":\"1234\",\"updateTime\":\"2023-07-25T22:36:00\",\"username\":\"2675525537@qq.com\"}]', '用户名重复，当前用户名已存在', 0, 10, '2023-07-25 22:36:09', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683848636783394816, 1636182933754609665, 2, 'com.zrkizzy.web.controller.core.UserController.updateUser()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"createTime\":\"2023-07-25T22:14:44\",\"id\":1683843225900548096,\"nickname\":\"1234\",\"updateTime\":\"2023-07-25T22:36:00\",\"username\":\"123@qq.com\"}]', 'Result(code=200, message=请求成功, data=true)', 1, 21, '2023-07-25 22:36:14', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683848827095744512, 1636182933754609665, 2, 'com.zrkizzy.web.controller.core.UserController.updateUser()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"createTime\":\"2023-07-25T22:14:44\",\"id\":1683843225900548096,\"nickname\":\"1111\",\"updateTime\":\"2023-07-25T22:36:14\",\"username\":\"123@qq.com\"}]', 'Result(code=200, message=请求成功, data=true)', 1, 111, '2023-07-25 22:36:59', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683848968431206400, 1636182933754609665, 2, 'com.zrkizzy.web.controller.core.UserController.updateUser()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"createTime\":\"2023-07-25T22:14:44\",\"id\":1683843225900548096,\"nickname\":\"1\",\"updateTime\":\"2023-07-25T22:36:59\",\"username\":\"123@qq.com\"}]', 'Result(code=200, message=请求成功, data=true)', 1, 37, '2023-07-25 22:37:33', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683850728679931904, 1636182933754609665, 2, 'com.zrkizzy.web.controller.core.UserController.updateLoginUser()', 'PUT', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"id\":1653794265890816000,\"nickname\":\"测试账号\",\"phone\":\"\",\"remark\":\"自古英雄出炼狱，破马长枪定乾坤！\",\"username\":\"2675525537@qq.com\"}]', 'Result(code=200, message=请求成功, data=1)', 1, 33, '2023-07-25 22:44:33', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683856532871053312, 1636182933754609665, 2, 'com.zrkizzy.web.controller.core.UserController.updateUserStatus()', 'GET', 1653794265890816000, '127.0.0.1', '本地登录', '[1683843225900548096]', 'Result(code=200, message=请求成功, data=true)', 1, 106, '2023-07-25 23:07:37', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683856543755272192, 1636182933754609665, 2, 'com.zrkizzy.web.controller.core.UserController.updateUserStatus()', 'GET', 1653794265890816000, '127.0.0.1', '本地登录', '[1683843225900548096]', 'Result(code=200, message=请求成功, data=true)', 1, 35, '2023-07-25 23:07:39', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683856787708575744, 1636182933754609665, 2, 'com.zrkizzy.web.controller.core.UserController.updateUserStatus()', 'GET', 1653794265890816000, '127.0.0.1', '本地登录', '[1683843225900548096]', 'Result(code=200, message=请求成功, data=true)', 1, 51, '2023-07-25 23:08:37', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683861498486587392, 1636182933754609665, 2, 'com.zrkizzy.web.controller.core.UserController.resetPassword()', 'GET', 1653794265890816000, '127.0.0.1', '本地登录', '[1683843225900548096]', 'Result(code=200, message=请求成功, data=true)', 1, 270, '2023-07-25 23:27:21', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683862267659026432, 1636182933754609665, 2, 'com.zrkizzy.web.controller.core.UserController.resetPassword()', 'GET', 1653794265890816000, '127.0.0.1', '本地登录', '[1683843225900548096]', 'Result(code=200, message=请求成功, data=true)', 1, 229, '2023-07-25 23:30:24', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683862313888645120, 1636182933754609665, 2, 'com.zrkizzy.web.controller.core.UserController.resetPassword()', 'GET', 1653794265890816000, '127.0.0.1', '本地登录', '[1683843225900548096]', 'Result(code=200, message=请求成功, data=true)', 1, 246, '2023-07-25 23:30:35', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683862553542787072, 1636182933754609665, 2, 'com.zrkizzy.web.controller.core.UserController.resetPassword()', 'GET', 1653794265890816000, '127.0.0.1', '本地登录', '[1683843225900548096]', 'Result(code=200, message=请求成功, data=true)', 1, 221, '2023-07-25 23:31:32', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683862560438222848, 1636182933754609665, 2, 'com.zrkizzy.web.controller.core.UserController.updateUserStatus()', 'GET', 1653794265890816000, '127.0.0.1', '本地登录', '[1683843225900548096]', 'Result(code=200, message=请求成功, data=true)', 1, 18, '2023-07-25 23:31:34', NULL);
INSERT INTO `tb_operate_log` (`id`, `module_id`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1683862984880816128, 1636182933754609665, 2, 'com.zrkizzy.web.controller.core.UserController.resetPassword()', 'GET', 1653794265890816000, '127.0.0.1', '本地登录', '[1653794265890816000]', 'Result(code=200, message=请求成功, data=true)', 1, 234, '2023-07-25 23:33:15', NULL);
COMMIT;
...
INSERT INTO `tb_resource` (`id`, `name`, `description`, `method`, `url`, `module_id`, `create_time`, `update_time`) VALUES (1683841299993591808, '更新指定用户信息', '更新指定用户信息', 'POST', '/admin/user/updateUser', 1636182933754609665, '2023-07-25 22:08:08', '2023-07-25 22:09:19');
...
INSERT INTO `tb_user` (`id`, `username`, `password`, `nickname`, `avatar`, `status`, `remark`, `create_time`, `update_time`) VALUES (1683843225900548096, '123@qq.com', '$2a$10$pKwYhNtnyTlhCj7M5c4qqeZr2vbS95JQnMl/HOydlPfg5KWBSIvS.', '1', 'https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg', 1, NULL, '2023-07-25 22:14:44', '2023-07-25 23:31:34');
COMMIT;
