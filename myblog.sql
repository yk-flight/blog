...
-- ----------------------------
BEGIN;
INSERT INTO `tb_operate_log` (`id`, `module_id`, `operate_content`, `type`, `method_name`, `request_method`, `user_id`, `operate_ip`, `operate_location`, `operate_param`, `operate_result`, `status`, `cost_time`, `create_time`, `update_time`) VALUES (1684442544491986944, 1636182933754609665, '更新系统基本配置', 2, 'com.zrkizzy.web.controller.system.ConfigController.saveConfig()', 'POST', 1653794265890816000, '127.0.0.1', '本地登录', '[{\"avatar\":\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg\",\"createTime\":\"2023-07-22T22:38:28\",\"id\":1682761996493127680,\"notice\":\"<p><strong style=\\\"color: rgb(96, 98, 102);\\\">尊敬的用户：</strong></p><p>欢迎来到我的个人博客! 我是Dream_飞翔，非常感谢您的来访。这里是我分享自己生活、学习和工作中的一些体验与见解的地方。您可以随意浏览我的文章以及后台的所有页面，也可以在评论区分享您的想法和反馈。如果您有任何问题或建议，请与我联系，祝您生活愉快！</p><p><strong style=\\\"color: rgb(96, 98, 102);\\\"><span class=\\\"ql-cursor\\\">﻿﻿﻿﻿﻿</span></strong><img src=\\\"https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/article/20230724214014.jpeg\\\" width=\\\"263\\\" style=\\\"display: block; margin: auto; cursor: nwse-resize;\\\"></p><p><strong style=\\\"color: rgb(96, 98, 102);\\\">其他：</strong></p><p>目前项目的技术栈为SpringBoot2，后续我会向SpringBoot3进行迁移</p><p><br></p>\",\"updateTime\":\"2023-07-27T13:39:28\",\"upload\":\"oss\"}]', 'Result(code=200, message=请求成功, data=1)', 1, 280, '2023-07-27 13:56:13', NULL);
