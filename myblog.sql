...
-- ----------------------------
BEGIN;
INSERT INTO `tb_resource` (`id`, `name`, `description`, `method`, `url`, `create_time`, `update_time`) VALUES (1636187548919267328, '获取所有用户', '获取当前系统中所有用户信息', 'POST', '/admin/user/list', '2023-03-16 10:17:39', '2023-03-16 03:45:27');
INSERT INTO `tb_resource` (`id`, `name`, `description`, `method`, `url`, `create_time`, `update_time`) VALUES (1636187548919267329, '获取所有角色', '获取当前系统中所有角色的信息', 'POST', '/admin/role/list', '2023-03-16 10:24:57', '2023-03-16 03:45:31');
COMMIT;

-- ----------------------------
-- Table structure for tb_resource_module
-- ----------------------------
DROP TABLE IF EXISTS `tb_resource_module`;
CREATE TABLE `tb_resource_module` (
  `id` bigint NOT NULL COMMENT '主键',
  ...
  `update_time` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='模块资源表';

-- ----------------------------
-- Records of tb_resource_module
-- ----------------------------
BEGIN;
INSERT INTO `tb_resource_module` (`id`, `resource_id`, `module_id`, `create_time`, `update_time`) VALUES (1636187548919267330, 1636187548919267328, 1636182933754609665, '2023-03-16 10:26:44', '2023-03-16 10:26:46');
INSERT INTO `tb_resource_module` (`id`, `resource_id`, `module_id`, `create_time`, `update_time`) VALUES (1636192313875103744, 1636187548919267329, 1636182933754609665, '2023-03-16 10:27:34', '2023-03-16 10:27:36');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_user` (`id`, `username`, `password`, `email`, `nickname`, `avatar`, `status`, `create_time`, `update_time`) VALUES (1633027432405532672, 'admin', '123456', '1072876976@qq.com', '世纪末的架构师', NULL, 1, '2023-03-07 16:52:16', '2023-03-07 08:52:24');
COMMIT;
...
INSERT INTO `tb_user_role` (`id`, `user_id`, `role_id`, `update_time`, `create_time`) VALUES (1635933361316823040, 1633027432405532672, 1633657944153260032, '2023-03-15 17:18:23', '2023-03-15 17:18:25');
COMMIT;
