...
-- ----------------------------
BEGIN;
INSERT INTO `tb_config` (`id`, `avatar`, `notice`, `upload`, `create_time`, `update_time`) VALUES (1682761996493127680, 'https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg', '<p><strong style=\"color: rgb(96, 98, 102);\">尊敬的用户：</strong></p><p>欢迎来到我的个人博客! 我是Dream_飞翔，非常感谢您的来访。这里是我分享自己生活、学习和工作中的一些体验与见解的地方。您可以随意浏览我的文章以及后台的所有页面，也可以在评论区分享您的想法和反馈。如果您有任何问题或建议，请与我联系，祝您生活愉快！</p><p><strong style=\"color: rgb(96, 98, 102);\">其他：</strong></p><p>目前项目的技术栈为SpringBoot2，后续我会向SpringBoot3进行迁移</p>', 'oss', '2023-07-22 22:38:28', '2023-07-24 15:41:42');
COMMIT;
...
INSERT INTO `tb_resource` (`id`, `name`, `description`, `method`, `url`, `module_id`, `create_time`, `update_time`) VALUES (1653929645323583488, '更新用户个人信息', '更新用户个人信息', 'POST', '/admin/user/updateUser', 1636182933754609665, '2023-05-01 00:46:55', '2023-07-18 09:28:04');
...
INSERT INTO `tb_resource` (`id`, `name`, `description`, `method`, `url`, `module_id`, `create_time`, `update_time`) VALUES (1663579937522581504, '更新用户头像', '更新用户头像', 'POST', '/admin/user/updateLoginUserAvatar', 1636182933754609665, '2023-05-31 00:16:36', '2023-05-30 16:48:54');
...
INSERT INTO `tb_role` (`id`, `name`, `mark`, `description`, `create_time`, `update_time`) VALUES (1633657944153260032, '默认用户', 'ROLE_LOGIN', '默认用户测试', '2023-03-09 10:36:20', '2023-06-11 01:55:33');
...
INSERT INTO `tb_user` (`id`, `username`, `password`, `nickname`, `avatar`, `status`, `remark`, `create_time`, `update_time`) VALUES (1653794265890816000, '2675525537@qq.com', '$2a$10$d4plA8fBNLdMFCQjo86vP.zrt714ei8llHZ.bvJk/OM1T.g77m5I2', '测试账号', 'https://blog-yk0504.oss-cn-hangzhou.aliyuncs.com/avatar/20230529192531.jpg', 1, '自古英雄出炼狱，破马长枪定乾坤！', '2023-05-03 16:15:23', '2023-06-06 11:09:55');
COMMIT;
