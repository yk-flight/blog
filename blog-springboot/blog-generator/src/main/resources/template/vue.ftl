                        ...
                        <#list fieldList as field>
                            <#if !field.isNull>
                                ...
                                <el-form-item label="${objectName}名称">
                                    <el-input v-model="queryParams.${javaName}" class="search-item" placeholder="请输入${field.comment}" size="small" clearable></el-input>
                                </el-form-item>
                            </#if>
                        </#list>
                        <!-- 创建时间 -->
        ...
        <el-dialog
            ...
            <div class="${entityLowerName}-wrapper" v-loading="${entityLowerName}Loading" element-loading-text="正在加载${objectName}信息">
                <el-form ref="${entityLowerName}Form" :model="formData" :rules="rules" label-width="80px" label-position="right">
                    <el-row :gutter="15">
                        <el-form-item label="${objectName}名称" prop="name">
                            <el-input v-model="formData.name" placeholder="请输入${objectName}名称" clearable>
                            </el-input>
                        </el-form-item>
                        <el-form-item label="${objectName}标识" prop="mark">
                            <el-input v-model="formData.mark" placeholder="请输入${objectName}标识" clearable>
                                <template slot="prepend" v-if="!formData.id">ROLE_</template>
                            </el-input>
                        </el-form-item>
                        <el-form-item label="${objectName}描述">
                            <el-input v-model="formData.description" type="textarea" placeholder="请输入${objectName}描述" :autosize="{minRows: 4, maxRows: 4}"></el-input>
                        </el-form-item>
                    </el-row>
                </el-form>
            </div>
    ...
    export default {
        ...
        data () {
            return {
                ...
                rules: {
                    // ${objectName}名称
                    name: [{ required: true, message: '请输入${objectName}名称', trigger: 'blur' }],
                    // ${objectName}标识
                    mark: [{ required: true, message: '请输入${objectName}标识', trigger: 'blur' }]
                },
                // ${objectName}对话框等待框
                ...
                // 列信息
                columns: [
                    { key: 0, label: '${objectName}名称', visible: true },
                    { key: 1, label: '${objectName}标识', visible: true },
                    { key: 2, label: '${objectName}描述', visible: true },
